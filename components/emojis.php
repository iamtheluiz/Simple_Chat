...
<div class="emoji-panel">
  <button id="emoji-picker" class="chat-input-tool waves-effect waves-light">
...
<script>
	...
	$(document).on("click",".intercom-emoji-picker-emoji",function(e){
	    ...
	    //$("#tx_chat").append($(this).html());
        //$("#tx_chat").value = ($(this).html());

        $("#tx_chat").html($("#tx_chat").html()+$(this).html());
	});
